...
class RoleManagementController extends Controller
{
    ...
    public function index()
    {
        ...
        return view(
            'admin-pages.role-management.index',
            ['roles' => $dataRoles]
        );
    }
    ...
    public function create()
    {
        ...
        return view('admin-pages.role-management.form', [
            "role" => $role,
            "method" => "POST",
    ...
    {
        return view(
            "admin-pages.role-management.detail",
            ["role" => $role]
        );
    }
    ...
    public function editPermission(Role $role)
    {
        ...
        return view("admin-pages.role-management.permission", [
            "role" => $role,
            "menus" => $menu
        ]);
    }
